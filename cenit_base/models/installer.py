...
class CollectionInstaller(models.TransientModel):
        ...
        for namespace in values:
            ...
            for schema in values:
                ...
                sch_data = {
                    ...
                    'slug': schema.get('slug') or schema.get('title').lower(),
    ...
    def install_collection(self, params=None):
        ...
        if params and params.get('name', False) == 'vetzip10':
        ...
        elif params and params.get('name', False) == 'vitalpet':
            path = "%s/%s" % (path, '598b1adf41678668d700201a')
        elif params and params.get('name', False) == 'callerinsight':
            path = "%s/%s" % (path, '5a9165fb4167860672013641')
            ...
            path = "%s/%s" % (path, '5cd2d63e41678606c1019770')
        elif params and params.get('name', False) == 'vetport':
            path = "%s/%s" % (path, '5cf186e60bf67e06bf000a0b')
